    ...
    <>
        <div >
            <div className='bg-slate-800 border border-slate-600 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-lg bg-opacity-30 relative transition-all duration-200'>
                ...
                <span>{errors.name && <span className='text-red-600 ml-1 text-sm'> {errors.name}</span>}</span>
                ...
                <span>{errors.password && <span className='text-red-600 ml-1 text-sm'> {errors.password}</span>}</span>
